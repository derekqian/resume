...
\begin{itemize}
	...
	\headerrow
		...
		{\emph{2011 -- 2011}}
	\begin{itemize*}
		\item The core board for Navigation Unit using i.MX51 processor and Windows CE 6.0/Android 2.3. (ARM, Platform Builder,
                Visual Studio, Board Support Package, Bootloader, Kernel, Driver)
...
\begin{description*}
	...
	\item[Tools:]
	Visual Studio, Platform Builder, Eclipse, emacs, git, svn, PADS
\end{description*}
\end{indentsection}
